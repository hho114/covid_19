...
import 'package:covid_19/utilities/counter.dart';
...
class Home extends StatefulWidget {
  ...
  Home({this.country, this.listCountries});
                  ...
                  Expanded(
                    child: DropdownButton(
                      ...
                      onChanged: (value) async {
                        var data = await getCountryByName(value);
                        updateUI(data);
                      },
                    ),
                  ),
